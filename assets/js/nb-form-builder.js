...
entry.fields.forEach(function (f) {
  ...
  if (t === 'lookup') {
    field.lookup = {
      ...
      additional_fields: _val('.nu-lookup-additional-fields') || '',
