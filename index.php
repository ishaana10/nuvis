...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['login_submit'])) {
    ...
    if ($username === '' || $password === '') {
        ...
        $loginError = 'Authentication service unavailable.';
    } else {
        try {
        ...
        <form method="post" action="index.php" autocomplete="off" novalidate>
            <div class="nu-field">
                ...
                <input id="nu_username" name="username" type="text" class="nu-input"
                       autocomplete="username" value="" required autofocus spellcheck="false">
            </div>
            <div class="nu-field">
                <label for="nu_password">Password</label>
                <input id="nu_password" name="password" type="password" class="nu-input"
